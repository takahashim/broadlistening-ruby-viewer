 ...
 * @param {string} name - Remixicon icon name (e.g., "close-line")
...
export class Dialogs {
   ...
   * @param {string} options.closingSelector - CSS selector for close buttons
  ...
  /**
   * Alias for open() - compatibility with decidim API
   */
  show() {
    this.open();
  }
  ...
  /**
   * Destroy the dialog instance and clean up
   */
  destroy() {
